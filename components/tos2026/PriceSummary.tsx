  ...
  return (
    <div className="tos-summary-sticky">
      <div className="tos-card rounded-2xl overflow-hidden">
        {/* Header */}
        <div className="bg-gradient-to-r from-[#D4A843]/20 to-[#D4A843]/5 p-5 border-b border-white/5">
        ...
        <div className="p-5 space-y-4">
          ...
          <div className="flex items-center justify-between text-sm">
            <span className="text-white/50">Total Attendees</span>
            <span className="text-white font-bold text-lg">{attendees.length}</span>
          </div>
            ...
            <div className="space-y-3">
              ...
              {breakdown.map((item) => (
                <div key={item.category.id} className="tos-price-update">
                  ...
                  <div className="ml-5 text-white/30 text-xs">
